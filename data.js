// data.js - VERSÃO COM O CAMINHO CORRETO E FINAL DO FTP
...
async function loadData() {
  ...
  for (let attempt = 1; attempt <= 3; attempt++) {
    ...
    try {
      ...
      // --- O ENDEREÇO CORRETO E VERIFICADO ESTÁ AQUI ---
      await client.downloadTo(writable, "pdet/fiscalizacao/seguranca-e-saude-no-trabalho/caepi/tgg_export_caepi.zip");
...
module.exports = { getCAInfo, loadData }// data.js - VERSÃO COM O CAMINHO CORRETO E FINAL DO FTP
const ftp = require('basic-ftp');
const unzipper = require('unzipper');
const { DBFFile } = require('dbffile');
const { PassThrough } = require('stream');
